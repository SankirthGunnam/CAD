...
class PackageImageGenerator:
    ...
    def generate_qfn_image(self, width_mm: float, height_mm: float, pin_count: int = 0) -> QPixmap:
    ...
    def get_or_create_package_image(self, image_name: str, package_info: str = "") -> Optional[QPixmap]:
