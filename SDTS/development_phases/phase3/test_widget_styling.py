...
class TestMainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        palette_label = QLabel(
            "Test 2: QPalette Styling (should be ORANGE background)")
        ...
        direct_label = QLabel(
            "Test 3: Direct CSS (should be GREEN background)")
    ...
    def _delayed_debug_info(self):
        ...
        print(
            f"  - Auto fill background: {self.css_widget.autoFillBackground()}")
        ...
        print(
            f"  - Auto fill background: {self.palette_widget.autoFillBackground()}")
        ...
        print(f"\nDirect Widget:")
        print(
            f"  - Auto fill background: {self.direct_widget.autoFillBackground()}")
        print(f"  - StyleSheet: {self.direct_widget.styleSheet()}")
        print(f"  - Visible: {self.direct_widget.isVisible()}")

        print(f"\nFrame Widget:")
        print(
            f"  - Auto fill background: {self.frame_widget.autoFillBackground()}")
