...
from apps.RBM.BCF.source.controllers.base_controller import BaseController
from apps.RBM.BCF.source.models.base_model import BaseModel
...
class ContextMenuTreeView(QTreeView):
    ...
    def _delete_item(self, item):
        ...
        if reply == QMessageBox.Yes:
            self.delete_item_requested.emit(item.name)
...
class LegacyBCFManager(QWidget):
    ...
    def setup_ui(self):
        ...
        # Create tree view
        self.tree_view = ContextMenuTreeView()
